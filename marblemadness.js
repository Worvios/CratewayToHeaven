...
// arrays to track all Obstacles and all Particles
var allObstacles = [];
var allParticles = [];

// floor used
var floorTexture = new THREE.ImageUtils.loadTexture( 'images/marblemapred.jpg' );
...
//bounding fence/box
var text = THREE.ImageUtils.loadTexture('images/border.jpg');
...
var balltexture = '';
var  text = Math.floor(Math.random() * 4);     // returns a random integer from 0 to 3

switch (text) {
    case 0: 
      balltexture='opal.jpg';
      break;
    case 1: 
      balltexture='opal1.jpg';
      break;				
    case 2: 
      balltexture='opal2.jpg';
      break;
    case 3: 
      balltexture='opal3.jpg';
      break;
  }
var material = new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('images/'+balltexture) } );
...
//check if the ball has fallen out of the world
...
swal ( "GAME OVER" ,  "Oops ! -- click on the map to see your progress !             Good luck next time !" ,  "error" )
...
var GOCamera = function (){
  ...
  player.remove(skybox);
  allObstacles[allObstacles.length-1].add(skybox);
